...
# Solicitud de los nombres completos de los padres.
nombre_completo_1 = str(input("Ingrese nombre completo del sujeto 1:"))
print(nombre_completo_1)

nombre_completo_2 = str(input("Ingrese nombre completo del sujeto 2:"))
print(nombre_completo_2)

# Solicitud nombre del hijo.
nombre = str(input("Ingrese nombre del hijo/a:"))
print(nombre)

# Extracción de los apellidos de los padres / madres / tutores.
