...
print(f"Cantidad: {cantidad_temperaturas}")
print(f"Promedio: {promedio:.2f}")
print(f"Temperatura máxima: {temperatura_max:.2f}")
print(f"Temperatura mínima: {temperatura_min:.2f}")